...
public class UiManager : MonoBehaviour
{
    ...
    void UiInitialization()//UI初始化
    {
        ...
        retractButton.onClick.AddListener(OnRetractButtonClicked);//收起资源面板
        expandButton.onClick.AddListener(OnExpandButtonClicked);//展开资源面板
    ...
    //[SerializeField] private Sprite[] informationimages;
    //[SerializeField] private Image toolTipImage; // 你的工具提示Image
    ...
    [SerializeField] private GameObject showTowerMenuPanel;//菜单面板
